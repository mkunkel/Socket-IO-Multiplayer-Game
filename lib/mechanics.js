...
exports.drinkPotion = function(game, player, fn){
  for(var i = 0; i < game.potions.length; i++){
    if (game.potions[i].x === player.x && game.potions[i].y === player.y) {
      var strength = game.potions[i].strength;
      game.potions[i].splice;
